...
import 'package:pokepedia/conexion/conexion_pokeapi.dart';
...
class PokemonDB{
  ...
  static Future<void> insertPokemonList(PokemonList pokemonList) async {
    final db = await ProveedorDB.db.database;
  ...
  // Si me diese tiempo aquí añadiría la galería
  // Para obtener todos los PokemonGallery con sus datos
  

  // Para obtener un único PokemonDetail (detalles) y sus datos por su ID
  ...
  // Si añado la galería: 
  //Para obtener un único GaleriaPokemon y sus datos por su ID

  // Para obtener todos los PokemonDetail(detalles) que estén marcados como Favoritos
  ...
  static Future<Map<String, dynamic>?> getLastDailyPokemon() async {
    ...
    if (result.isNotEmpty) {
      ...
      // Fetch(Obtener) el PokemonDetail por separado usando el ID
  ...
  // Si me diese tiempo
  //Para manejar búsquedas de GaleriaPokemon por ID o por Nombre
  
  // Para manejar búsquedas de Pokemons por ID o por Nombre
