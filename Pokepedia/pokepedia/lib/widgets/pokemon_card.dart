...
import 'package:pokepedia/utils/colors.dart';
import 'package:pokepedia/utils/screen_sizes.dart';
import 'package:pokepedia/utils/general_utils.dart';
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    fontSize: pokemon.name.length > 18
                        ? ScreenUtil.diagonal(context) * 0.018  // Efecto que reduce el tamaño de la fuente si el nombre tiene más de 18 caracteres
                        : ScreenUtil.diagonal(context) * 0.02,  // Tamaño de fuente por defecto
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      color: MyColors.getColorByType(type),
        boxShadow: [
          BoxShadow(offset: const Offset(1, 1), blurRadius: 2, color: Colors.black.withOpacity(0.3), spreadRadius: 1.5)
        ]
    ),
    // child: Center(
    //   child: SvgPicture.asset(
    //   Aquí se cargarán las imagenes de los tipos de pokemons cuando las tenga
    //     'assets/images/...',
